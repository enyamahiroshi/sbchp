...
switch ($post_type_slug) {
  case 'nag-c': //長野中央ハウジングパーク
    ...
    $park_map_image = 'park/nag-c/img-facility-map-nagano.png?20260216';
    ...
    <?php if (have_posts()) : ?>
      <ul class="list-modelhouse">
        <?php while (have_posts()) : the_post(); ?>
          ...
          ?>
          <li class="list-item <?php echo get_post_field('post_name', get_the_ID()); ?>">
            <a href="<?php the_permalink(); ?>" class="post-group">
              ...
              <h2 class="modelhouse-name"><?php if ($modelhouse_name) {
                                            echo $modelhouse_name;
                                          } else {
                                            the_title();
                                          } ?></h2>
