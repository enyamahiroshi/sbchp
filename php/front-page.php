<?php get_header(); ?>
<div class="mv">
  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/home/img-mv.png?20260304" alt="">
</div>
        ...
        <div class="detail-container">
          <ul class="park-overview --nag-c">
            ...
            <li class="park-overview__data data-tel">
              <span class="icon"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/common/ico-tel.svg" alt="" width="23" height="23"></span>
              <p><a href="tel:026-263-8991">026-263-8991</a></p>
            </li>
          </ul>
      ...
      <section class="park">
        ...
        <div class="detail-container">
          <ul class="park-overview --ueda">
            ...
            <li class="park-overview__data data-tel">
              <span class="icon"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/common/ico-tel.svg" alt="" width="23" height="23"></span>
              <p><a href="tel:0268-21-0633">0268-21-0633</a></p>
            </li>
          </ul>
          <div class="park-button">
      ...
      <section class="park">
        ...
        <div class="detail-container">
          <ul class="park-overview --saku">
            ...
            <li class="park-overview__data data-tel">
              <span class="icon"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/common/ico-tel.svg" alt="" width="23" height="23"></span>
              <p><a href="tel:0267-66-6650">0267-66-6650</a></p>
            </li>
          </ul>
          <div class="park-button">
