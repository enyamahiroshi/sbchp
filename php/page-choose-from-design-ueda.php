  ...
  <header class="page-header page-header-full">
    <div class="inner">
      <h1 class="page-header__title page-header__title--design">
        <img class="img-park_logo" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/common/logo-ueda-hp.svg" alt="SBC上田ハウジングパークロゴ" width="128" height="12">デザインから選ぶ
      </h1>
    </div>
  </header>
